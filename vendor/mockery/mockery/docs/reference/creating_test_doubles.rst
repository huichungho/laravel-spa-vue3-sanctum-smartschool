...
See the cookcustomer entry on :doc:`../cookcustomer/big_parent_class` for an example
...
.. note::
    ...
    See :doc:`../cookcustomer/not_calling_the_constructor` for more details.
...
See the cookcustomer entry on :doc:`../cookcustomer/class_constants` for an example
